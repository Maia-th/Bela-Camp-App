...
const RecipeDetailScreen = () => {
  ...
  useEffect(() => {
    const checkIfSaved = async () => {
      try {
        ...
        console.error("Erro ao verificar se a receita está salva:", error);
      }
    };
  ...
  const getYouTubeEmbedUrl = (url) => {
    // exemplo url: https://www.youtube.com/watch?v=mTvlmY4vCug
  ...
  const handleToggleSave = async () => {
    ...
    try {
      if (isSaved) {
        ...
        if (!response.ok) throw new Error("Falha ao remover receita");
        ...
        if (!response.ok) throw new Error("Falha ao salvar receita");
        setIsSaved(true);
      }
    } catch (error) {
      console.error("Erro ao alternar salvamento da receita:", error);
  ...
  if (loading) return <LoadingSpinner message="Carregando detalhes da receita..." />;
          ...
          <View style={recipeDetailStyles.titleSection}>
            ...
            {recipe.area && (
              <View style={recipeDetailStyles.locationRow}>
                ...
                <Text style={recipeDetailStyles.locationText}>{recipe.area} Culinária</Text>
              </View>
            )}
          </View>
        </View>
        ...
        <View style={recipeDetailStyles.contentSection}>
          ...
          <View style={recipeDetailStyles.statsContainer}>
            <View style={recipeDetailStyles.statCard}>
              ...
              <Text style={recipeDetailStyles.statLabel}>Tempo de Preparo</Text>
            </View>
            ...
            <View style={recipeDetailStyles.statCard}>
              ...
              <Text style={recipeDetailStyles.statLabel}>Porções</Text>
            </View>
          </View>
          ...
          {recipe.youtubeUrl && (
            <View style={recipeDetailStyles.sectionContainer}>
              <View style={recipeDetailStyles.sectionTitleRow}>
                ...
                <Text style={recipeDetailStyles.sectionTitle}>Vídeo Tutorial</Text>
              </View>
          ...
          <View style={recipeDetailStyles.sectionContainer}>
            <View style={recipeDetailStyles.sectionTitleRow}>
              ...
              <Text style={recipeDetailStyles.sectionTitle}>Instruções</Text>
              <View style={recipeDetailStyles.countBadge}>
                ...
                <View key={index} style={recipeDetailStyles.instructionCard}>
                  ...
                  <View style={recipeDetailStyles.instructionContent}>
                    ...
                    <View style={recipeDetailStyles.instructionFooter}>
                      <Text style={recipeDetailStyles.stepLabel}>Passo {index + 1}</Text>
