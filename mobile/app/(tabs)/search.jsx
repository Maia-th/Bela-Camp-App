...
const SearchScreen = () => {
  ...
  const performSearch = async (query) => {
    ...
    // pesquisar por nome primeiro, depois por ingrediente se não houver resultados
    ...
    <View style={searchStyles.container}>
      ...
      <View style={searchStyles.resultsSection}>
        <View style={searchStyles.resultsHeader}>
          ...
          <Text style={searchStyles.resultsCount}>{recipes.length} encontradas</Text>
        </View>
...
function NoResultsFound() {
  return (
    <View style={searchStyles.emptyState}>
      ...
      <Text style={searchStyles.emptyTitle}>Nenhuma receita encontrada</Text>
      <Text style={searchStyles.emptyDescription}>
        Tente ajustar sua busca ou experimente palavras-chave diferentes
      </Text>
    </View>
  );
}